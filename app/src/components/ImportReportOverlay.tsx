...
export function ImportReportOverlay({ open, onClose }: ImportReportOverlayProps) {
  ...
  useEffect(() => {
    ...
    fetch('/api/import-runs/latest')
      .then((r) => {
        if (r.status === 404) throw new Error('No import run has been recorded yet. Run the metadata loader first.')
  ...
  return (
    ...
    >
      <div className="dialog-box dialog-box--import-report">
        <header className="dialog-header about-dialog-header">
          <h1 id="import-report-title">Data quality report</h1>
          <button type="button" className="dialog-close" onClick={onClose} aria-label="Close">
            ×
          </button>
        </header>
        <div className="dialog-body import-report-body">
