  ...
  return (
    <div className="content-page">
      <header className="content-page-header">
        <h2 className="content-page-title">About the portal</h2>
      </header>

      <div className="content-page-body about-body">
        <h2>Vision</h2>
        <p>
          <i>
            A globally connected gateway to sustained marine biodiversity observations, making BioEco
            Essential Ocean Variable monitoring programs visible, discoverable, and actionable.
          </i>
        </p>

        <h2>What are GOOS BioEco EOVs</h2>
        <p>
          GOOS EOVs are defined as{' '}
          <i>
            the minimum set of ocean variables that are needed to assess ocean state and variability
            for important global ocean phenomena, and to provide essential data for applications that
            support societal benefit. They are derived from sustained individual measurements, or
            combinations of measurements, that can be undertaken at global scale and in a
        ...
        <p>
          Together, this information provides a view of global marine biodiversity monitoring coverage
          and enables the identification of observing gaps, a fundamental starting point for improving
          coordination and directing efforts where they are most needed. This understanding supports
          biological and ecosystem observation at local, subnational, national, and global scales, and
          underpins contributions to international conventions, multilateral environmental agreements,
          and global marine biodiversity assessments.
        </p>

        <h2>What is included in the BioEco Portal</h2>
        <p>
          The Portal includes information about long-term (+5 years) ocean observing programs that have
          been collecting data on BioEco EOVs:
        </p>
        <ul>
        ...
        <p>
          ...
          and select these programmes by name, selecting a locality on the map, or filtering by EOVs.
          The portal provides information about the variables observed, the standardisations and
        ...
        <p>
          ...
          . This App requires a GitHub account to use. Once logged in, users can create and edit
          metadata entries for their observing programmes. You may need to request edit permissions.
          Please contact us (helpdesk@obis.org) if you require any assistance.
        </p>
        <p>
